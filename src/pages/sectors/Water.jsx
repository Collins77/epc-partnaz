            ...
            <div className='bg-white px-[40px] py-[60px]'>
                ...
                <div className='grid grid-cols-4 gap-6'>
                    <div className='flex flex-col gap-3 items-center hover:shadow-md p-3 rounded-md'>
                        ...
                        <h1 className='font-bold'>Water Treatment</h1>
                        <p className='text-sm text-gray-500 text-center'>Advanced treatment technologies for drinking water and industrial applications</p>
                    </div>
                    <div className='flex flex-col gap-3 items-center hover:shadow-md p-3 rounded-md'>
                        <div className='w-[50px] h-[50px] bg-yellow-500 rounded-md flex items-center justify-center'>
                            <Recycle />
                        </div>
                        <h1 className='font-bold'>Wastewater Management</h1>
                        <p className='text-sm text-gray-500 text-center'>Comprehensive wastewater treatment and resource recovery systems</p>
                    </div>
                    <div className='flex flex-col gap-3 items-center hover:shadow-md p-3 rounded-md'>
                        <div className='w-[50px] h-[50px] bg-yellow-500 rounded-md flex items-center justify-center'>
                            <Funnel />
                        </div>
                        <h1 className='font-bold'>Desalination</h1>
                        <p className='text-sm text-gray-500 text-center'>Seawater and brackish water desalination with energy optimization</p>
                    </div>
                    <div className='flex flex-col gap-3 items-center hover:shadow-md p-3 rounded-md'>
                        <div className='w-[50px] h-[50px] bg-yellow-500 rounded-md flex items-center justify-center'>
                            <Leaf />
                        </div>
                        <h1 className='font-bold'>Environmental Solutions</h1>
                        <p className='text-sm text-gray-500 text-center'>Sustainable technologies for environmental protection and remediation</p>
                    </div>
                </div>
            </div>
            <div className='bg-[#f9fafc] px-[40px] py-[60px]'>
                ...
                <div className='grid grid-cols-3 gap-6'>
                    <div className='p-4 bg-white shadow-md rounded-md flex flex-col gap-3'>
                        ...
                        <p className='text-sm text-gray-500'>Advanced reverse osmosis facility with energy recovery systems</p>
                        <div className='flex flex-col gap-2'>
                            <div className='flex justify-between items-center'>
                                <p className='text-gray-500 text-sm'>Capacity:</p>
                                <h1 className='font-bold text-yellow-500 text-sm'>200 MGD</h1>
                            </div>
                            <div className='flex justify-between items-center'>
                    ...
                    <div className='p-4 bg-white shadow-md rounded-md flex flex-col gap-3'>
                        <div className='flex items-center justify-between'>
                            <h1 className='font-bold text-sm'>Wastewater Treatment - Brazil</h1>
                            <p className='text-[12px] bg-blue-50 rounded-xl text-blue-500 px-2 py-1'>In Progress</p>
                        </div>
                        <p className='text-sm text-gray-500'>Biological treatment plant with nutrient removal capabilities</p>
                        <div className='flex flex-col gap-2'>
                            <div className='flex justify-between items-center'>
                                <p className='text-gray-500 text-sm'>Scope:</p>
                                <h1 className='font-bold text-yellow-500 text-sm'>150 MGD</h1>
                            </div>
                            <div className='flex justify-between items-center'>
                                <p className='text-gray-500 text-sm'>Value:</p>
                    ...
                    <div className='p-4 bg-white shadow-md rounded-md flex flex-col gap-3'>
                        <div className='flex items-center justify-between'>
                            <h1 className='font-bold text-sm'>Water Recycling Facility - Australia</h1>
                            <p className='text-[12px] bg-green-50 rounded-xl text-green-500 px-2 py-1'>Completed</p>
                        </div>
                        <p className='text-sm text-gray-500'>Advanced water recycling for industrial and municipal use</p>
                        <div className='flex flex-col gap-2'>
                            <div className='flex justify-between items-center'>
                                <p className='text-gray-500 text-sm'>Capacity:</p>
                                <h1 className='font-bold text-yellow-500 text-sm'>50 MGD</h1>
                            </div>
                            <div className='flex justify-between items-center'>
                                <p className='text-gray-500 text-sm'>Value:</p>
