    ...
    return (
        <div>
            <div className='px-[40px] py-[40px] h-[50vh] flex flex-col gap-5 justify-center relative' style={{ backgroundImage: `url(${construct})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
                ...
                <div className='relative z-20 flex flex-col gap-4'>
                    <div className="flex flex-col gap-2 sm:items-start items-center justify-center">
                        ...
                        <p className="text-gray-300 sm:w-[60%] sm:text-base text-sm">Comprehensive project advisory services from conception to commissioning. We guide EPC contractors and project owners through every phase of complex project delivery.</p>
                    </div>
                    <div className='grid grid-cols-3 gap-2 sm:items-start items-center sm:w-[50%]'>
                        <div className='flex items-center flex-col'>
                            <h1 className='sm:text-3xl text-xl font-bold text-yellow-500'>250+</h1>
            ...
            <div className='sm:grid sm:grid-cols-3 flex flex-col sm:gap-2 gap-6 px-[40px] py-[60px] bg-white'>
                <div className='flex items-center flex-col sm:gap-0 gap-2'>
                    <div className='w-[40px] h-[40px] rounded-md bg-yellow-500 flex items-center justify-center'>
                        <Building />
                    </div>
                    <h1 className='sm:text-3xl text-xl font-bold'>18+ <span className='text-yellow-500 text-base'>years</span></h1>
                ...
                <div className='flex items-center flex-col sm:gap-0 gap-2'>
                    ...
                    <h1 className='sm:text-3xl text-xl font-bold'>95% <span className='text-yellow-500 text-base'>success</span></h1>
                ...
                <div className='flex items-center flex-col sm:gap-0 gap-2'>
                    ...
                    <h1 className='sm:text-3xl text-xl font-bold'>25% <span className='text-yellow-500 text-base'>average</span></h1>
            ...
            <div className='px-[40px] py-[60px] bg-[#f9fafc]'>
                <div className='flex flex-col gap-1 items-center mb-[40px]'>
                    <h1 className='font-bold sm:text-3xl text-xl'>Complete Project Lifecycle Support</h1>
                    <p className='text-gray-500 text-center sm:w-[60%] text-sm sm:text-base'>Expert guidance through every phase of EPC project delivery, ensuring optimal outcomes and minimal risk.</p>
                </div>
            ...
            <div className='px-[40px] py-[60px] bg-white'>
                <div className='flex flex-col gap-1 items-center mb-[40px]'>
                    <h1 className='font-bold sm:text-3xl text-xl'>Complete Project Lifecycle Support</h1>
                    <p className='text-gray-500 text-center sm:w-[60%] sm:text-base text-sm'>Expert guidance through every phase of EPC project delivery, ensuring optimal outcomes and minimal risk.</p>
                </div>
            ...
            <div className='px-[40px] py-[60px] bg-black flex sm:flex-row flex-col sm:gap-4 gap-6'>
                <div className='sm:w-[50%] flex flex-col gap-4'>
                    <h1 className='sm:text-3xl text-xl font-bold text-white'>Why Choose Our EPC Consultancy?</h1>
                    <p className='text-gray-300 sm:text-base text-sm'>With over 18 years of combined EPC experience and a proven track record across multiple sectors, we bring unmatched expertise to every project.</p>
                    <div className='flex flex-col gap-3 text-white'>
                        <div className='flex gap-3'>
                            <Dot color='gold' />
                            <div className='flex flex-col gap-1'>
                                <h1 className='sm:text-lg text-base font-semibold'>Deep Industry Knowledge</h1>
                        ...
                        <div className='flex gap-3'>
                            <Dot color='gold' />
                            <div className='flex flex-col gap-1'>
                                <h1 className='sm:text-lg text-base font-semibold'>Global Network</h1>
                        ...
                        <div className='flex gap-3'>
                            <Dot color='gold' />
                            <div className='flex flex-col gap-1'>
                                <h1 className='sm:text-lg text-base font-semibold'>Risk Mitigation</h1>
                        ...
                        <div className='flex gap-3'>
                            <Dot color='gold' />
                            <div className='flex flex-col gap-1'>
                                <h1 className='sm:text-lg text-base font-semibold'>Technology Integration</h1>
                ...
                <div className='sm:w-[50%] flex sm:flex-row flex-col gap-4'>
                    <div className='flex flex-col gap-4 sm:w-[50%]'>
                        <div className='flex flex-col gap-2 bg-[#2d1000] rounded-md text-white p-6'>
                            ...
                            <h1 className='font-bold sm:text-2xl text-xl text-amber-500'>$15B+</h1>
                        ...
                        <div className='flex flex-col gap-2 bg-[#002712] rounded-md text-white p-6'>
                            ...
                            <h1 className='font-bold sm:text-2xl text-xl text-green-500'>25%</h1>
                    ...
                    <div className='flex flex-col gap-4 sm:w-[50%] sm:mt-[40px]'>
                        <div className='flex flex-col gap-2 bg-[#071633] rounded-md text-white p-6'>
                            ...
                            <h1 className='font-bold sm:text-2xl text-xl text-blue-500'>98%</h1>
                        ...
                        <div className='flex flex-col gap-2 bg-[#231234] rounded-md text-white p-6'>
                            ...
                            <h1 className='font-bold sm:text-2xl text-xl text-purple-500'>35+</h1>
            ...
            <div className='px-[40px] py-[60px] bg-linear-to-r from-yellow-400 via-orange-500 to-yellow-600 flex flex-col gap-3 items-center justify-center'>
                <h1 className='sm:text-3xl text-xl font-bold'>Ready to Optimize Your EPC Project?</h1>
                <p className='text-gray-700 sm:w-[60%] sm:text-base text-sm text-center'>Partner with our experienced EPC consultancy team to ensure project success from conception to commissioning.</p>
                <button onClick={() => navigate('/contact')} className='bg-black px-4 py-2 text-white cursor-pointer rounded-md hover:bg-yellow-500 transition-all duration-300'>Get EPC Consultancy Support</button>
            </div>
