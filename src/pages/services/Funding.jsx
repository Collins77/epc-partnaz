        ...
        <div>
            <div className='px-[40px] py-[40px] h-[50vh] flex flex-col gap-5 justify-center relative' style={{ backgroundImage: `url(${inv})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
                ...
                <div className='relative z-20 flex flex-col gap-4'>
                    <div className="flex flex-col gap-2 items-start justify-center">
                        ...
                        <p className="text-gray-300 sm:w-[60%] sm:text-normal text-sm">Unlock capital opportunities through our extensive network of investors and funding programs. We connect visionary projects with the right capital partners for sustainable success.</p>
                    </div>
                    <div className='grid grid-cols-3 gap-2 items-start w-[50%]'>
                        <div className='flex items-center flex-col'>
                            <h1 className='text-3xl font-bold text-yellow-500'>$50B+</h1>
                            <p className='text-sm text-gray-500'>Funding Secured</p>
                        </div>
                        <div className='flex items-center flex-col'>
                            <h1 className='text-3xl font-bold text-yellow-500'>350+</h1>
            ...
            <div className='px-[40px] py-[60px] bg-[#f9fafc]'>
                <div className='flex flex-col gap-1 items-center mb-[40px]'>
                    <h1 className='font-bold text-3xl'>Comprehensive Funding Services</h1>
                    <p className='text-gray-500 text-center w-[60%]'>End-to-end funding solutions from initial strategy development to closing and beyond.</p>
                </div>
            ...
            <div className='px-[40px] py-[60px] bg-white'>
                <div className='flex flex-col gap-1 items-center mb-[40px]'>
                    <h1 className='font-bold text-3xl'>Extensive Capital Network</h1>
                    <p className='text-gray-500 text-center w-[60%]'>Access to diverse funding sources spanning the global capital markets ecosystem.</p>
                </div>
            ...
            <div className='px-[40px] py-[60px] bg-black'>
                <div className='flex flex-col gap-1 items-center mb-[40px]'>
                    <h1 className='font-bold text-3xl text-white'>Extensive Capital Network</h1>
                    <p className='text-gray-300 text-center w-[60%]'>Access to diverse funding sources spanning the global capital markets ecosystem.</p>
                </div>
                <div className='grid grid-cols-3 gap-6'>
                    <div className='flex flex-col gap-2 bg-[#002712] rounded-md text-white p-6'>
                        <h1 className='font-bold'>International Trade</h1>
                        <h1 className='font-bold text-3xl text-green-500'>$450M</h1>
                    ...
                    <div className='flex flex-col gap-2 bg-[#071633] rounded-md text-white p-6'>
                        ...
                        <h1 className='font-bold text-3xl text-blue-500'>$320M</h1>
                    ...
                    <div className='flex flex-col gap-2 bg-[#231234] rounded-md text-white p-6'>
                        ...
                        <h1 className='font-bold text-3xl text-purple-500'>$280M</h1>
